...
interface IMasterChef {
    ...
    function updateEmissionRate(uint256 _afitxPerBlock) external;
}
...
contract Timelock is Ownable {
    ...
    constructor(IMasterChef masterchef_, address admin_, uint delay_) public {
    ...
    function updateEmissionRate(uint256 _afitxPerBlock) public onlyOwner {
        uint256 perBlock = _afitxPerBlock;
